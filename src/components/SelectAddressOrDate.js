...
export default class SelectAddressOrDate extends Component {
    ...
    // <SelectAddressOrDate
// ref={ref => this.SelectAddressOrDate = ref}
// callBackDateValue={this.callBackDateValue.bind(this)}/>
//state = time: [],
    // openTime() {
    //     this.SelectAddressOrDate.showDate(this.state.time)
    // }
    //
                ...
                style={[styles.contain, {
                    transform: [{
                        translateY: this.state.xPosition.interpolate({
                            inputRange: [0, 1],
                            outputRange: [gScreen.deviceHeight, 0]
                        }),
                    }]
                }]}>
            </Animated.View>
