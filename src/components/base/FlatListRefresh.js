...
export class FlatListRefresh extends React.Component {
    static propTypes = {
    ...
    renderListHeaderComponent() {
        ...
        return (
            <View>
                <Animated.View ref={(e) => {
                    if (e) this.animatedView = e;
                }} style={[{height: this.state.headerHeight, overflow: 'hidden'}]}>
                    {typeof this.props.refreshControl !== 'function'
                        ? (
                            <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                                <Image source={images.loading_spinner}
